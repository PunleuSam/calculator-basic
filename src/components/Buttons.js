  ...
  render() {
    return (
      <div className="buttons">
        <button id="parenthesis-open" onClick={this.props.onParenthesis}>
          (
        </button>
        <button id="parenthesis-close" onClick={this.props.onParenthesis}>
          )
        </button>
        <button id="modulo" onClick={this.props.onOperator}>
          %
        </button>
